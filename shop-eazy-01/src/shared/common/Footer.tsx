...
export function Footer({ title }: { title: string }) {
  ...
  return (
    ...
    <div className="container-fluid bg-dark text-secondary mt-5 pt-5">
                ...
                <div className="row">
                    <div className="col-md-4 mb-5">
                        ...
                        <div className="d-flex flex-column justify-content-start">
                            <a className="text-secondary mb-2" href="#"><FontAwesomeIcon icon={faAngleRight} className="me-2" />Home</a>
                            <a className="text-secondary mb-2" href="#"><FontAwesomeIcon icon={faAngleRight} className="me-2" />Our Shop</a>
                            <a className="text-secondary mb-2" href="#"><FontAwesomeIcon icon={faAngleRight} className="me-2" />Shop Detail</a>
                            <a className="text-secondary mb-2" href="#"><FontAwesomeIcon icon={faAngleRight} className="me-2" />Shopping Cart</a>
                            <a className="text-secondary mb-2" href="#"><FontAwesomeIcon icon={faAngleRight} className="me-2" />Checkout</a>
                            <a className="text-secondary" href="#"><FontAwesomeIcon icon={faAngleRight} className="me-2" />Contact Us</a>
                        </div>
                    </div>
                    <div className="col-md-4 mb-5">
        ...
        <div className="row border-top mx-xl-5 py-4" style={{ border: '1px solid', borderColor: 'rgba(198, 35, 35, 0.1)', padding: '20px' }}>
