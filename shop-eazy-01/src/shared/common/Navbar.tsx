        ...
        <div className="row px-xl-5">
             ...
             <div className="col-lg-3 d-none d-lg-block">
                ...
                {isOpenMenu && (
                    ...
                    style={{ width: '300px', zIndex: 999, backgroundColor: '#f0f0f0' }}
                    >
                    <div className="navbar-nav w-100" style={{ width: '300px', }}>
                        <div
                        ...
                        <div className="nav-link dropdown-toggle" style={{ cursor: 'pointer' }}>
                            Dresses <FontAwesomeIcon icon={faAngleRight} className="float-end mt-1" />
                        </div>
                        {isDropdownOpenMenu && (
