...
import { faShoppingCart, faHeart, faSyncAlt, faSearch, faStar, faMapMarkerAlt, faEnvelope, faPhoneAlt, faAngleDown, faAngleRight, faThLarge, faBars } from '@fortawesome/free-solid-svg-icons';
