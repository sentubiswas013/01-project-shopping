...
import { faShoppingCart, faHeart, faSyncAlt, faSearch, faCheck, faShippingFast, faExchangeAlt, faPhoneVolume, faStar, faMapMarkerAlt, faEnvelope, faPhoneAlt, faAngleDown, faAngleRight, faThLarge, faBars } from '@fortawesome/free-solid-svg-icons';
